...
static void mips_xburst_perseus_init(MachineState *machine)
{
	...
	if (!intc) {
		fprintf(stderr, "qemu: can not found interrupt controller on perseus\n");
		exit(1);
	}
...
{
	mc->desc = "mips xburst perseus platform";
	mc->init = mips_xburst_perseus_init;
	mc->default_ram_size = (1024 * 1024 * 1024);
}

DEFINE_MACHINE("perseus", mips_machine_init)
