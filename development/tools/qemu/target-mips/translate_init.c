...
{
	{
		.name = "xburst1-x1000",
		.CP0_PRid = 0x2ed1024f,
		.CP0_Config0 = MIPS_CONFIG0 | (MMU_TYPE_R4000 << CP0C0_MT) | (1 << CP0C0_AR),
		.CP0_Config1 = MIPS_CONFIG1 | (31 << CP0C1_MMU)	|
			(1 << CP0C1_IS) | (4 << CP0C1_IL) | (4 << CP0C1_IA) |
			(1 << CP0C1_DS) | (4 << CP0C1_DL) | (4 << CP0C1_DA) |
			(1 << CP0C1_FP),
		.CP0_Config2 = MIPS_CONFIG2 | (3 << CP0C2_SS) | (6 << CP0C2_SL) | (4 << CP0C2_SA),
		.CP0_Config3 = MIPS_CONFIG3 | (1 << CP0C3_VInt),
		.CP1_fcr0 = (1 << FCR0_L) | (1 << FCR0_W) | (1 << FCR0_D) | (1 << FCR0_S),
		.CP0_LLAddr_rw_bitmask = 0,
		.CP0_LLAddr_shift = 0,
		.SYNCI_Step = 32,
		.CCRes = 2,
		.CP0_Status_rw_bitmask = 0x3060FF17,
		.CP0_PageGrain = (1U << CP0PG_RIE) | (1 << CP0PG_XIE),
		.CP0_PageGrain_rw_bitmask = (1U << CP0PG_RIE) | (1 << CP0PG_XIE) | (1 << CP0PG_IEC),
		.SEGBITS = 32,
		.PABITS = 32,
		.insn_flags = CPU_MIPS32R3,
		.mmu_type = MMU_TYPE_R4000,
	},
	{
                /*
                 * STATUS: 
                 *   MMU type is MMU_TYPE_R4000(0x1), not (VTLB + FTLB)(should be 0x4).
                 *   L1 instruction cache size is 32 bytes line size.
                 *   L1 instruction cache associativity is 8-ways.
                 *   L1 Data cache number of sets per way is 128 set per way.
                 *   L1 Data cache line size is 32 bytes.
                 *   L1 Data cache associativity is 8-ways.
                 *   L2 cache number of sets per way is 1024 set per way(512KB).
                 *   L2 cache line size is 64 bytes.
                 *   L2 cache associativity is 8-ways.
                 *   UserLocal register is implemented.
                 *   CP0C4_KScrExist is 0xfc.
                 *   CP0_PRid = 0xd01000.
                 *   FR = 1.
                 * TODO
                 */
		...
		.CP0_Config1 = MIPS_CONFIG1 | (31 << CP0C1_MMU)	|
			...
			(1 << CP0C1_FP),
		.CP0_Config2 = MIPS_CONFIG2 | (3 << CP0C2_SS) | (6 << CP0C2_SL) | (4 << CP0C2_SA),
		/* .CP0_Config1 = MIPS_CONFIG1 | (0x1F << CP0C1_MMU)	| */
		/* 	(1 << CP0C1_IS) | (4 << CP0C1_IL) | (7 << CP0C1_IA) | */
		/* 	(1 << CP0C1_DS) | (4 << CP0C1_DL) | (7 << CP0C1_DA) | */
		/* 	(1 << CP0C1_FP), */
		/* .CP0_Config2 = MIPS_CONFIG2 | (4 << CP0C2_SS) | (5 << CP0C2_SL) | (7 << CP0C2_SA), */
		...
		.SYNCI_Step = 32,
		.CCRes = 2,
		.CP0_Status_rw_bitmask = 0x3460FF17,
		.CP0_PageGrain = (1U << CP0PG_RIE) | (1 << CP0PG_XIE),
		.CP0_PageGrain_rw_bitmask = (1U << CP0PG_RIE) | (1 << CP0PG_XIE) | (1 << CP0PG_IEC),
