...
/* AFU opcodes */
#define MASK_AFU_MINOR(op)    (MASK_OP_MAJOR(op) | (op & (0x1F << 21)))
enum {
    OPC_AFU_3RFC2   = (0x10 << 21) | OPC_CP2,
    OPC_AFU_3RC2_1  = (0x11 << 21) | OPC_CP2,
    OPC_AFU_3RC2    = (0x12 << 21) | OPC_CP2,
    OPC_AFU_ELM2RC2 = (0x14 << 21) | OPC_CP2,
    OPC_AFU_2RC2    = (0x1a << 21) | OPC_CP2,
    OPC_AFU_4R      = (0x1d << 21) | OPC_CP2,
};

enum {
    OPC_AFU_FCMUL_df  = (0x3 << 1) | OPC_AFU_3RFC2,
    OPC_AFU_FEXUPLC_df= OPC_AFU_3RFC2,
    OPC_AFU_FEXUPRC_df= (0x4 << 1) | OPC_AFU_3RFC2,
    OPC_AFU_ELMC2_5   = (0x15 << 21) | OPC_CP2,
    OPC_AFU_ELMC2_6   = (0x16 << 21) | OPC_CP2,
    OPC_AFU_ELMC2_7   = (0x17 << 21) | OPC_CP2,
    OPC_AFU_PCNT_V    = (0x0 << 16) | OPC_AFU_2RC2,
    OPC_AFU_BEXT_df   = (0x1 << 16) | OPC_AFU_2RC2,
    OPC_AFU_BEXP_0_df = (0x2 << 16) | OPC_AFU_2RC2,
    OPC_AFU_BEXP_1_df = (0x3 << 16) | OPC_AFU_2RC2,
    OPC_AFU_ACCUL_df  = (0x5 << 16) | OPC_AFU_2RC2,
    OPC_AFU_ACCUR_df  = (0x6 << 16) | OPC_AFU_2RC2,
    OPC_AFU_ACCSL_df  = (0x7 << 16) | OPC_AFU_2RC2,
    OPC_AFU_ACCSR_df  = (0x8 << 16) | OPC_AFU_2RC2,
    OPC_AFU_SLL_V     = OPC_AFU_3RC2,
    OPC_AFU_BMU_V     = OPC_AFU_3RC2 | 0x1,
    OPC_AFU_SRL_V     = OPC_AFU_3RC2 | 0x4,
    OPC_AFU_MOVBT_B   = OPC_AFU_3RC2,
    OPC_AFU_MOVBP_B   = OPC_AFU_3RC2 | 0x4,
    OPC_AFU_SATS_B_H  = OPC_AFU_3RC2,
    OPC_AFU_SATS_H_W  = OPC_AFU_3RC2 | 0x1,
    OPC_AFU_SATU_B_H  = OPC_AFU_3RC2 | 0x4,
    OPC_AFU_SATU_H_W  = OPC_AFU_3RC2 | 0x5,
    OPC_AFU_ADDSL_H   = OPC_AFU_3RC2_1 | 0x1,
    OPC_AFU_ADDSL_W   = OPC_AFU_3RC2_1 | 0x2,
    OPC_AFU_ADDSR_H   = OPC_AFU_3RC2_1 | 0x5,
    OPC_AFU_ADDSR_W   = OPC_AFU_3RC2_1 | 0x6,
    OPC_AFU_ADDUL_H   = OPC_AFU_3RC2_1 | 0x1,
    OPC_AFU_ADDUL_W   = OPC_AFU_3RC2_1 | 0x2,
    OPC_AFU_ADDUR_H   = OPC_AFU_3RC2_1 | 0x5,
    OPC_AFU_ADDUR_W   = OPC_AFU_3RC2_1 | 0x6,
    OPC_AFU_SUBSL_H   = OPC_AFU_3RC2_1 | 0x1,
    OPC_AFU_SUBSL_W   = OPC_AFU_3RC2_1 | 0x2,
    OPC_AFU_SUBSR_H   = OPC_AFU_3RC2_1 | 0x5,
    OPC_AFU_SUBSR_W   = OPC_AFU_3RC2_1 | 0x6,
    OPC_AFU_SUBUL_H   = OPC_AFU_3RC2_1 | 0x1,
    OPC_AFU_SUBUL_W   = OPC_AFU_3RC2_1 | 0x2,
    OPC_AFU_SUBUR_H   = OPC_AFU_3RC2_1 | 0x5,
    OPC_AFU_SUBUR_W   = OPC_AFU_3RC2_1 | 0x6,
    OPC_AFU_MULSL_H   = OPC_AFU_3RC2_1 | 0x1,
    OPC_AFU_MULSL_W   = OPC_AFU_3RC2_1 | 0x2,
    OPC_AFU_MULSR_H   = OPC_AFU_3RC2_1 | 0x5,
    OPC_AFU_MULSR_W   = OPC_AFU_3RC2_1 | 0x6,
    OPC_AFU_MULUL_H   = OPC_AFU_3RC2_1 | 0x1,
    OPC_AFU_MULUL_W   = OPC_AFU_3RC2_1 | 0x2,
    OPC_AFU_MULUR_H   = OPC_AFU_3RC2_1 | 0x5,
    OPC_AFU_MULUR_W   = OPC_AFU_3RC2_1 | 0x6,
    OPC_AFU_MOVE_W    = OPC_AFU_ELM2RC2,
};
...
static void gen_base_index_addr (DisasContext *ctx, TCGv addr,
                                 int base, int index)
{
    if (base == 0) {
...
static void gen_afu_3rfc2(CPUMIPSState *env, DisasContext *ctx)
{
#define MASK_AFU_3RF(op)    (MASK_AFU_MINOR(op) | (op & (0x1f << 1)))
    uint8_t df = (ctx->opcode) & 0x1;
    uint8_t wt = (ctx->opcode >> 16) & 0x1f;
    uint8_t ws = (ctx->opcode >> 11) & 0x1f;
    uint8_t wd = (ctx->opcode >> 6) & 0x1f;
    ...
    switch (MASK_AFU_3RF(ctx->opcode)) {
    case OPC_AFU_FCMUL_df:
        gen_helper_afu_fcmul_df(cpu_env, tdf, twd, tws, twt);
        break;
    case OPC_AFU_FEXUPLC_df:
        gen_helper_afu_fexuplc_df(cpu_env, tdf, twd, tws, twt);
        break;
    case OPC_AFU_FEXUPRC_df:
        gen_helper_afu_fexuprc_df(cpu_env, tdf, twd, tws, twt);
        break;
    default:
        MIPS_INVAL("AFU instruction");
        generate_exception(ctx, EXCP_RI);
        break;
    }
...
static void gen_afu_3rc2_1(CPUMIPSState *env, DisasContext *ctx)
{
#define MASK_AFU_3RC2_1_C1(op)    (MASK_AFU_MINOR(op) | (op & (0x7 << 3)))
#define MASK_AFU_3RC2_1_C2(op)    (MASK_AFU_MINOR(op) | (op & 0x7))

    uint8_t c1 = (ctx->opcode >> 3) & 0x7;
    uint8_t df = (ctx->opcode) & 0x3;
    uint8_t wt = (ctx->opcode >> 16) & 0x1f;
    uint8_t ws = (ctx->opcode >> 11) & 0x1f;
    uint8_t wd = (ctx->opcode >> 6) & 0x1f;
    ...
    /* adjust df value for floating-point instruction */
    tcg_gen_movi_i32(tdf, df);

    switch (c1){
    case 0:
    {
        switch (MASK_AFU_3RC2_1_C2(ctx->opcode)) {
        case OPC_AFU_ADDSL_H:
        case OPC_AFU_ADDSL_W:
            gen_helper_afu_addsl_df(cpu_env, tdf, twd, tws, twt);
            break;
        case OPC_AFU_ADDSR_H:
        case OPC_AFU_ADDSR_W:
            gen_helper_afu_addsr_df(cpu_env, tdf, twd, tws, twt);
            break;
        default:
            MIPS_INVAL("AFU instruction");
            generate_exception(ctx, EXCP_RI);
    ...
    {
        switch (MASK_AFU_3RC2_1_C2(ctx->opcode)) {
        case OPC_AFU_ADDUL_H:
        case OPC_AFU_ADDUL_W:
            gen_helper_afu_addul_df(cpu_env, tdf, twd, tws, twt);
            break;
        case OPC_AFU_ADDUR_H:
        case OPC_AFU_ADDUR_W:
            gen_helper_afu_addur_df(cpu_env, tdf, twd, tws, twt);
            break;
        default:
            MIPS_INVAL("AFU instruction");
            generate_exception(ctx, EXCP_RI);
    ...
    {
        switch (MASK_AFU_3RC2_1_C2(ctx->opcode)) {
        case OPC_AFU_SUBSL_H:
        case OPC_AFU_SUBSL_W:
            gen_helper_afu_subsl_df(cpu_env, tdf, twd, tws, twt);
            break;
        case OPC_AFU_SUBSR_H:
        case OPC_AFU_SUBSR_W:
            gen_helper_afu_subsr_df(cpu_env, tdf, twd, tws, twt);
            break;
        default:
            MIPS_INVAL("AFU instruction");
            generate_exception(ctx, EXCP_RI);
    ...
    {
        switch (MASK_AFU_3RC2_1_C2(ctx->opcode)) {
        case OPC_AFU_SUBUL_H:
        case OPC_AFU_SUBUL_W:
            gen_helper_afu_subul_df(cpu_env, tdf, twd, tws, twt);
            break;
        case OPC_AFU_SUBUR_H:
        case OPC_AFU_SUBUR_W:
            gen_helper_afu_subur_df(cpu_env, tdf, twd, tws, twt);
            break;
        default:
            MIPS_INVAL("AFU instruction");
            generate_exception(ctx, EXCP_RI);
    ...
    {
        switch (MASK_AFU_3RC2_1_C2(ctx->opcode)) {
        case OPC_AFU_MULSL_H:
        case OPC_AFU_MULSL_W:
            gen_helper_afu_mulsl_df(cpu_env, tdf, twd, tws, twt);
            break;
        case OPC_AFU_MULSR_H:
        case OPC_AFU_MULSR_W:
            gen_helper_afu_mulsr_df(cpu_env, tdf, twd, tws, twt);
            break;
        default:
            MIPS_INVAL("AFU instruction");
            generate_exception(ctx, EXCP_RI);
    ...
    {
        switch (MASK_AFU_3RC2_1_C2(ctx->opcode)) {
        case OPC_AFU_MULUL_H:
        case OPC_AFU_MULUL_W:
            gen_helper_afu_mulul_df(cpu_env, tdf, twd, tws, twt);
            break;
        case OPC_AFU_MULUR_H:
        case OPC_AFU_MULUR_W:
            gen_helper_afu_mulur_df(cpu_env, tdf, twd, tws, twt);
            break;
        default:
            MIPS_INVAL("AFU instruction");
            generate_exception(ctx, EXCP_RI);
...
static void gen_afu_3rc2(CPUMIPSState *env, DisasContext *ctx)
{
#define MASK_AFU_3RC2_C1(op)    (MASK_AFU_MINOR(op) | (op & (0x7 << 3)))
#define MASK_AFU_3RC2_C2(op)    (MASK_AFU_MINOR(op) | (op & 0x7))
    ...
    case 0:
    {
        switch (MASK_AFU_3RC2_C2(ctx->opcode)) {
        case OPC_AFU_SLL_V:
            gen_helper_afu_sll_v(cpu_env, twd, tws, twt);
            break;
        case OPC_AFU_BMU_V:
            gen_helper_afu_bmu_v(cpu_env, twd, tws, twt);
            break;
        case OPC_AFU_SRL_V:
            gen_helper_afu_srl_v(cpu_env, twd, tws, twt);
            break;
        default:
            MIPS_INVAL("AFU instruction");
            generate_exception(ctx, EXCP_RI);
    ...
    case 1:
        switch (MASK_AFU_3RC2_C2(ctx->opcode)) {
        case OPC_AFU_SATS_B_H:
        case OPC_AFU_SATS_H_W:
            gen_helper_afu_sats_df(cpu_env, tdf, twd, tws, twt);
            break;
        case OPC_AFU_SATU_B_H:
        case OPC_AFU_SATU_H_W:
            gen_helper_afu_satu_df(cpu_env, tdf, twd, tws, twt);
            break;
        default:
            MIPS_INVAL("AFU instruction");
            generate_exception(ctx, EXCP_RI);
    ...
    case 4:
        switch (MASK_AFU_3RC2_C2(ctx->opcode)) {
        case OPC_AFU_MOVBT_B:
            gen_helper_afu_movbt_b(cpu_env, twd, tws, twt);
            break;
        case OPC_AFU_MOVBP_B:
            gen_helper_afu_movbp_b(cpu_env, twd, tws, twt);
            break;
        default:
            MIPS_INVAL("AFU instruction");
            generate_exception(ctx, EXCP_RI);
...
static void gen_afu_2rc2(CPUMIPSState *env, DisasContext *ctx)
{
#define MASK_AFU_2RC2_C1(op)    (MASK_AFU_MINOR(op) | (op & (0xf << 2)))
#define MASK_AFU_2RC2_C2(op)    (MASK_AFU_MINOR(op) | (op & (0x1f << 16)))

    uint8_t c1 = (ctx->opcode >> 2) & 0xf;
    uint8_t df = (ctx->opcode) & 0x3;
    uint8_t ws = (ctx->opcode >> 11) & 0x1f;
    uint8_t wd = (ctx->opcode >> 6) & 0x1f;
    ...
    case 0:
    {
        switch (MASK_AFU_2RC2_C2(ctx->opcode)) {
        case OPC_AFU_PCNT_V:
            gen_helper_afu_pcnt_v(cpu_env, tdf, twd, tws);
            break;
        case OPC_AFU_BEXT_df:
            gen_helper_afu_bext_df(cpu_env, tdf, twd, tws);
            break;
        case OPC_AFU_BEXP_0_df:
            gen_helper_afu_bexp_0_df(cpu_env, tdf, twd, tws);
            break;
        case OPC_AFU_BEXP_1_df:
            gen_helper_afu_bexp_1_df(cpu_env, tdf, twd, tws);
            break;
        case OPC_AFU_ACCUL_df:
            gen_helper_afu_accul_df(cpu_env, tdf, twd, tws);
            break;
        case OPC_AFU_ACCUR_df:
            gen_helper_afu_accur_df(cpu_env, tdf, twd, tws);
            break;
        case OPC_AFU_ACCSL_df:
            gen_helper_afu_accsl_df(cpu_env, tdf, twd, tws);
            break;
        case OPC_AFU_ACCSR_df:
            gen_helper_afu_accsr_df(cpu_env, tdf, twd, tws);
            break;
        default:
            MIPS_INVAL("AFU instruction");
            generate_exception(ctx, EXCP_RI);
    ...
    case 14:
    {
        ...
        case 0:
        {
            uint8_t m = (ctx->opcode >> 16) & 0x1f;
            TCGv_i32 tm = tcg_const_i32(m);

            gen_helper_afu_slli_v(cpu_env, tm, twd, tws);
            tcg_temp_free_i32(tm);
            break;
        }
        default:
    ...
    case 15:
    {
        ...
        case 0:
        {
            ...
            gen_helper_afu_srli_v(cpu_env, tm, twd, tws);
            tcg_temp_free_i32(tm);
            break;
        }
        default:
...
static void gen_afu_elm2rc2(CPUMIPSState *env, DisasContext *ctx)
{
#define MASK_AFU_ELM2RC2(op)    (MASK_AFU_MINOR(op) | (op & (0x1f << 16)))

    uint8_t c1 = (ctx->opcode >> 16) & 0x1f;
    uint8_t df = (ctx->opcode) & 0x3;
    uint8_t ws = (ctx->opcode >> 11) & 0x1f;
    uint8_t wd = (ctx->opcode >> 6) & 0x1f;
    ...
    case 0:
    {
        switch (MASK_AFU_MINOR(ctx->opcode) | (ctx->opcode & (0x3 << 4)) ) {
        case OPC_AFU_MOVE_W:
        {
            uint8_t n = ctx->opcode & 3;
            uint8_t m = (ctx->opcode >> 2) & 3;
            TCGv_i32 tn = tcg_temp_new_i32();
            TCGv_i32 tm = tcg_temp_new_i32();

            tcg_gen_movi_i32(tn, n);
            tcg_gen_movi_i32(tm, m);

            gen_helper_afu_move_w(cpu_env, tm, tn, twd, tws);
    ...
    case 1:
    {
        if (((ctx->opcode >> 2) & 0xf) == 0xc) { /* stextu.w */
            uint8_t n = ctx->opcode & 0x3;
            uint8_t base = ws;
            TCGv_i32 tn = tcg_temp_new_i32();
            TCGv taddr = tcg_temp_new();

            tcg_gen_addi_tl(cpu_gpr[base], cpu_gpr[base], 4);
            gen_base_index_addr(ctx, taddr, base, 0);
            tcg_gen_movi_i32(tn, n);

            gen_helper_afu_stext_w(cpu_env, twd, tn, taddr);

            tcg_temp_free_i32(tn);
        } else if (((ctx->opcode >> 1) & 0x1f) == 0x1c) { /* stextu.d */
            uint8_t n = ctx->opcode & 0x1;
            uint8_t base = ws;
            TCGv_i32 tn = tcg_temp_new_i32();
            TCGv taddr = tcg_temp_new();

            tcg_gen_addi_tl(cpu_gpr[base], cpu_gpr[base], 8);
            gen_base_index_addr(ctx, taddr, base, 0);
            tcg_gen_movi_i32(tn, n);

            gen_helper_afu_stext_d(cpu_env, twd, tn, taddr);
...
static void gen_afu_4r(CPUMIPSState *env, DisasContext *ctx)
{
    uint8_t df = (ctx->opcode) & 0x1;
    uint8_t wt = (ctx->opcode >> 16) & 0x1f;
    uint8_t ws = (ctx->opcode >> 11) & 0x1f;
    uint8_t wd = (ctx->opcode >> 6) & 0x1f;
    uint8_t wr = (ctx->opcode >> 1) & 0x1f;

    TCGv_i32 twd = tcg_const_i32(wd);
    TCGv_i32 tws = tcg_const_i32(ws);
    TCGv_i32 twt = tcg_const_i32(wt);
    TCGv_i32 twr = tcg_const_i32(wr);

    switch (df) {
    case 0:
        /* OPC_VSHFR.B_df */
        gen_helper_afu_vshfr_df(cpu_env, twd, tws, twt, twr);
        break;
    case 1:
        /* OPC_BMR.V_df */
        gen_helper_afu_bmr_df(cpu_env, twd, tws, twt, twr);
        break;
    default:
        MIPS_INVAL("AFU instruction");
        generate_exception(ctx, EXCP_RI);
    ...
    tcg_temp_free_i32(tws);
    tcg_temp_free_i32(twt);
    tcg_temp_free_i32(twr);
}

static void gen_afu_elmc2_5(CPUMIPSState *env, DisasContext *ctx)
{
    if (((ctx->opcode >> 2) & 0xf) == 0xf) { /* ldinss.w */
        uint8_t n = (ctx->opcode) & 0x3;
        uint8_t base = (ctx->opcode >> 16) & 0x1f;
        uint8_t index = (ctx->opcode >> 11) & 0x1f;
        uint8_t wd = (ctx->opcode >> 6) & 0x1f;
        uint8_t i;
        ...
        tcg_gen_movi_i32(tn, n);
        gen_load_gpr(tmp, index);

        for (i = 0; i < n; i++)
            tcg_gen_shri_tl(tmp, tmp, 8);

        tcg_gen_addi_tl(tmp, tmp, 1);
        tcg_gen_muli_i32(tmp, tmp, 4);
        gen_op_addr_add(ctx, taddr, cpu_gpr[base], tmp);
        gen_helper_afu_ldins_w(cpu_env, twd, tn, taddr);
    ...
    } else if (((ctx->opcode >> 2) & 0xf) == 0xc) { /* ldins.w */
        uint8_t n = (ctx->opcode) & 0x3;
        uint8_t base = (ctx->opcode >> 16) & 0x1f;
        uint8_t index = (ctx->opcode >> 11) & 0x1f;
        uint8_t wd = (ctx->opcode >> 6) & 0x1f;
        ...
        gen_base_index_addr(ctx, taddr, base, index);
        ...
        tcg_temp_free_i32(twd);
        tcg_temp_free_i32(tn);
    } else if (((ctx->opcode >> 1) & 0x1f) == 0x1c) { /* ldins.d */
        uint8_t n = (ctx->opcode) & 0x1;
        uint8_t base = (ctx->opcode >> 16) & 0x1f;
        uint8_t index = (ctx->opcode >> 11) & 0x1f;
        uint8_t wd = (ctx->opcode >> 6) & 0x1f;
        ...
        gen_helper_afu_ldins_d(cpu_env, twd, tn, taddr);
...
static void gen_afu_elmc2_6(CPUMIPSState *env, DisasContext *ctx)
{
    if (((ctx->opcode >> 4) & 0x3) == 0) { /* vsldi.b */
        uint8_t n = (ctx->opcode) & 0xf;
        uint8_t wt = (ctx->opcode >> 16) & 0x1f;
        uint8_t ws = (ctx->opcode >> 11) & 0x1f;
        uint8_t wd = (ctx->opcode >> 6) & 0x1f;
        ...
        gen_helper_afu_vsldi_b(cpu_env, twd, tws, twt, tn);

        tcg_temp_free_i32(twd);
        tcg_temp_free_i32(tws);
        tcg_temp_free_i32(twt);
        tcg_temp_free_i32(tn);
    } else if (((ctx->opcode >> 2) & 0xf) == 0xc) { /* stext.w */
        uint8_t n = (ctx->opcode) & 0x3;
        uint8_t base = (ctx->opcode >> 16) & 0x1f;
        uint8_t index = (ctx->opcode >> 11) & 0x1f;
        uint8_t wd = (ctx->opcode >> 6) & 0x1f;
        ...
        tcg_temp_free_i32(twd);
        tcg_temp_free_i32(tn);
    } else if (((ctx->opcode >> 1) & 0x1f) == 0x1c) { /* stext.d */
        uint8_t n = (ctx->opcode) & 0x1;
        uint8_t base = (ctx->opcode >> 16) & 0x1f;
        uint8_t index = (ctx->opcode >> 11) & 0x1f;
        uint8_t wd = (ctx->opcode >> 6) & 0x1f;
    ...
    } else if (((ctx->opcode >> 2) & 0xf) == 0xf) { /* ldinssu.w */
        uint8_t n = (ctx->opcode) & 0x3;
        uint8_t base = (ctx->opcode >> 16) & 0x1f;
        uint8_t index = (ctx->opcode >> 11) & 0x1f;
        uint8_t wd = (ctx->opcode >> 6) & 0x1f;
        ...
        gen_op_addr_add(ctx, taddr, cpu_gpr[base], tmp);
        gen_helper_afu_ldins_w(cpu_env, twd, tn, taddr);
        tcg_gen_add_tl(cpu_gpr[base], cpu_gpr[base], tmp);
...
static void gen_afu_elmc2_7(CPUMIPSState *env, DisasContext *ctx)
{
    if (((ctx->opcode >> 2) & 0xf) == 0xc) { /* ldinsu.w */
        uint8_t n = (ctx->opcode) & 0x3;
        uint8_t base = (ctx->opcode >> 16) & 0x1f;
        uint8_t index = (ctx->opcode >> 11) & 0x1f;
        uint8_t wd = (ctx->opcode >> 6) & 0x1f;
        ...
        tcg_gen_add_tl(cpu_gpr[base], cpu_gpr[base], cpu_gpr[index]);

        tcg_temp_free_i32(twd);
        tcg_temp_free_i32(tn);
    } else if (((ctx->opcode >> 1) & 0x1f) == 0x1c) { /* ldinsu.d */
        uint8_t n = (ctx->opcode) & 0x1;
        uint8_t base = (ctx->opcode >> 16) & 0x1f;
        uint8_t index = (ctx->opcode >> 11) & 0x1f;
        uint8_t wd = (ctx->opcode >> 6) & 0x1f;
    ...
    } else if (((ctx->opcode >> 3) & 0x7) == 0x4) { /* ldinssu2.w */
        uint8_t n = (ctx->opcode) & 0x7;
        uint8_t base = (ctx->opcode >> 16) & 0x1f;
        uint8_t index = (ctx->opcode >> 11) & 0x1f;
        uint8_t wd = (ctx->opcode >> 6) & 0x1f;
        uint8_t i;
...
static void gen_afu(CPUMIPSState *env, DisasContext *ctx)
{
    uint32_t opcode = ctx->opcode;
    check_insn(ctx, ASE_MSA);
    check_msa_access(ctx);

    switch (MASK_AFU_MINOR(opcode)) {
    case OPC_AFU_3RFC2:
        gen_afu_3rfc2(env, ctx);
        break;
    case OPC_AFU_3RC2_1:
        gen_afu_3rc2_1(env, ctx);
        break;
    case OPC_AFU_3RC2:
        gen_afu_3rc2(env, ctx);
        break;
    case OPC_AFU_ELM2RC2:
        gen_afu_elm2rc2(env, ctx);
        break;
    case OPC_AFU_2RC2:
        gen_afu_2rc2(env, ctx);
        break;
    case OPC_AFU_4R:
        gen_afu_4r(env, ctx);
        break;
    case OPC_AFU_ELMC2_5:
        gen_afu_elmc2_5(env, ctx);
        break;
    case OPC_AFU_ELMC2_6:
        gen_afu_elmc2_6(env, ctx);
        break;
    case OPC_AFU_ELMC2_7:
        gen_afu_elmc2_7(env, ctx);
        break;
    default:
        MIPS_INVAL("AFU instruction");
        generate_exception(ctx, EXCP_RI);
...
static void decode_opc(CPUMIPSState *env, DisasContext *ctx)
{
    ...
    case OPC_BNEZC: /* OPC_JIALC, OPC_SDC2 */
        ...
        break;
    case OPC_CP2:
        /* CP0_PRid == 0x0001A800 is cpu P5600 */
	if (env->CP0_PRid == 0x0001A800) {
          check_insn(ctx, ASE_MSA);
          gen_afu(env, ctx);
	} else {
          check_insn(ctx, INSN_LOONGSON2F);
