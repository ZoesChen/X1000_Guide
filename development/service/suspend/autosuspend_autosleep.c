...
static int autosuspend_autosleep_enable(void)
{
    ...
    LOGV("autosuspend_autosleep_enable\n");
	...
	LOGV("autosuspend_autosleep_enable done\n");
...
static int autosuspend_autosleep_disable(void)
{
    ...
    LOGV("autosuspend_autosleep_disable\n");
    ...
    LOGV("autosuspend_autosleep_disable done\n");
