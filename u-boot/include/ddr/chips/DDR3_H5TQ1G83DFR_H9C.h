 ...
 */
#define DDR_tRFC   DDR__ns(215) 	/* AUTO-REFRESH command period. DDR3 - ns*/
#define DDR_tXP    DDR__tck(3)	/*FIXME DDR3 only: Exit active power down to any valid command, ns*/
...
#define DDR_tFAW   DDR__ns(50)	/* Four bank activate period, DDR3 - tCK */
