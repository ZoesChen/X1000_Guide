...
/***********************************
* test app for audio and bluetooth *
************************************/

在根目录test_app/bluetooth目录下执行./test_bluetooth.sh 在串口输出：
	received 7
	04 0e 04 01 03 0c 00
后测试正常完成。
在test_app/audio目录下执行./snktit -P -p smooth_sting_11.wav -o 80(扬声器需要外接) 音乐即可正常播放。
