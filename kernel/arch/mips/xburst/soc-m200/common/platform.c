...
#if defined(CONFIG_SOUND_JZ_I2S_V12) || IS_ENABLED(CONFIG_SND_ASOC_JZ_AIC_I2S)
#if !defined(CONFIG_JZ_INTERNAL_CODEC_V12) && !IS_ENABLED(CONFIG_SND_ASOC_JZ_ICDC_D1)
	I2S_PORTDE,
#endif
#endif
#if defined(CONFIG_SOUND_JZ_SPDIF_V12) || IS_ENABLED(CONFIG_SND_ASOC_JZ_AIC_SPDIF)
	I2S_PORTDE,
#endif
#if defined(CONFIG_SOUND_JZ_PCM_V12) || IS_ENABLED(CONFIG_SND_ASOC_JZ_PCM)
	PCM_PORTF,
#endif
...
struct jzuart_platform_data jzuart0_pdata = {
#ifdef	CONFIG_SERIAL_UART0_WAKEUP
	.support_wakeup = 1,
#else
	.support_wakeup = 0,
#endif
...
struct jzuart_platform_data jzuart1_pdata = {
#ifdef	CONFIG_SERIAL_UART1_WAKEUP
	.support_wakeup = 1,
#else
	.support_wakeup = 0,
#endif
...
struct jzuart_platform_data jzuart2_pdata = {
#ifdef	CONFIG_SERIAL_UART2_WAKEUP
	.support_wakeup = 1,
#else
	.support_wakeup = 0,
#endif
...
struct jzuart_platform_data jzuart3_pdata = {
#ifdef	CONFIG_SERIAL_UART3_WAKEUP
	.support_wakeup = 1,
#else
	.support_wakeup = 0,
#endif
