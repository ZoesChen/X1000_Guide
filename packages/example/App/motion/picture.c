 ...
 */
extern unsigned int vpu_phyaddr;
extern void * jz_jpeg;
extern void * vpu_start;
extern unsigned int vpu_cxtan_addr;
                       ...
                       unsigned char *image, int quality)
{
    ...
    case VIDEO_PALETTE_YUV420P:
		return jz_put_jpeg_yuv420p_memory(jz_jpeg, dest_image, image_size, image/*vpu_start*/ , cnt->imgs.width, cnt->imgs.height, 0);
