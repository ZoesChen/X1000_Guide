...
int display_to_fb(__u8 *frame, struct display_info *dis, struct fb_info *fb)
{
	struct fb_var_screeninfo vinfo;
	int src_fourcc = dis->fmt.fourcc;
//	int src_format = dis->fmt.format;
	...
	//		   YUYV_to_RGB565_zoom (frame, fb->fb_mem, src_height , src_width,  fb->xres*32);
