...
static struct Ratio_n2m ipu_ratio_table[486] = {
	...
	{17.000000, 17, 1},{8.500000, 17, 2},{5.666667, 17, 3},{4.250000, 17, 4},
	{3.400000, 17, 5},{2.833333, 17, 6},{2.428571, 17, 7},{2.125000, 17, 8},
	{1.888889, 17, 9},{1.700000, 17, 10},{1.545455, 17, 11},{1.416667, 17, 12},
	{1.307692, 17, 13},{1.214286, 17, 14},{1.133333, 17, 15},{1.062500, 17, 16},
	{0.944444, 17, 18},{0.894737, 17, 19},{0.850000, 17, 20},{0.809524, 17, 21},
	{0.772727, 17, 22},{0.739130, 17, 23},{0.708333, 17, 24},{0.680000, 17, 25},
	{0.653846, 17, 26},{0.629630, 17, 27},{0.607143, 17, 28},{0.586207, 17, 29},
	{0.566667, 17, 30},{0.548387, 17, 31},{0.531250, 17, 32},{18.000000, 18, 1},
	{3.600000, 18, 5},{2.571429, 18, 7},{1.636364, 18, 11},{1.384615, 18, 13},
	{1.058824, 18, 17},{0.947368, 18, 19},{0.782609, 18, 23},{0.720000, 18, 25},
	{0.620690, 18, 29},{0.580645, 18, 31},{19.000000, 19, 1},{9.500000, 19, 2},
	{6.333333, 19, 3},{4.750000, 19, 4},{3.800000, 19, 5},{3.166667, 19, 6},
	{2.714286, 19, 7},{2.375000, 19, 8},{2.111111, 19, 9},{1.900000, 19, 10},
	{1.727273, 19, 11},{1.583333, 19, 12},{1.461538, 19, 13},{1.357143, 19, 14},
	{1.266667, 19, 15},{1.187500, 19, 16},{1.117647, 19, 17},{1.055556, 19, 18},
	{0.950000, 19, 20},{0.904762, 19, 21},{0.863636, 19, 22},{0.826087, 19, 23},
	{0.791667, 19, 24},{0.760000, 19, 25},{0.730769, 19, 26},{0.703704, 19, 27},
	{0.678571, 19, 28},{0.655172, 19, 29},{0.633333, 19, 30},{0.612903, 19, 31},
	{0.593750, 19, 32},{20.000000, 20, 1},{6.666667, 20, 3},{2.857143, 20, 7},
	{2.222222, 20, 9},{1.818182, 20, 11},{1.538462, 20, 13},{1.176471, 20, 17},
	{1.052632, 20, 19},{0.952381, 20, 21},{0.869565, 20, 23},{0.740741, 20, 27},
	{0.689655, 20, 29},{0.645161, 20, 31},{21.000000, 21, 1},{10.500000, 21, 2},
	{5.250000, 21, 4},{4.200000, 21, 5},{2.625000, 21, 8},{2.100000, 21, 10},
	{1.909091, 21, 11},{1.615385, 21, 13},{1.312500, 21, 16},{1.235294, 21, 17},
	{1.105263, 21, 19},{1.050000, 21, 20},{0.954545, 21, 22},{0.913043, 21, 23},
	{0.840000, 21, 25},{0.807692, 21, 26},{0.724138, 21, 29},{0.677419, 21, 31},
	{0.656250, 21, 32},{22.000000, 22, 1},{7.333333, 22, 3},{4.400000, 22, 5},
	{3.142857, 22, 7},{2.444444, 22, 9},{1.692308, 22, 13},{1.466667, 22, 15},
	{1.294118, 22, 17},{1.157895, 22, 19},{1.047619, 22, 21},{0.956522, 22, 23},
	{0.880000, 22, 25},{0.814815, 22, 27},{0.758621, 22, 29},{0.709677, 22, 31},
	{14.500000, 29, 2},{9.666667, 29, 3},{7.250000, 29, 4},{5.800000, 29, 5},
	{4.833333, 29, 6},{4.142857, 29, 7},{3.625000, 29, 8},{3.222222, 29, 9},
	{2.900000, 29, 10},{2.636364, 29, 11},{2.416667, 29, 12},{2.230769, 29, 13},
	{2.071429, 29, 14},{1.933333, 29, 15},{1.812500, 29, 16},{1.705882, 29, 17},
	{1.611111, 29, 18},{1.526316, 29, 19},{1.450000, 29, 20},{1.380952, 29, 21},
	{1.318182, 29, 22},{1.260870, 29, 23},{1.208333, 29, 24},{1.160000, 29, 25},
	{1.115385, 29, 26},{1.074074, 29, 27},{1.035714, 29, 28},{0.966667, 29, 30},
	{0.935484, 29, 31},{0.906250, 29, 32},{30.000000, 30, 1},{4.285714, 30, 7},
	{2.727273, 30, 11},{2.307692, 30, 13},{1.764706, 30, 17},{1.578947, 30, 19},
	{1.304348, 30, 23},{1.034483, 30, 29},{0.967742, 30, 31},{31.000000, 31, 1},
	{15.500000, 31, 2},{10.333333, 31, 3},{7.750000, 31, 4},{6.200000, 31, 5},
	{5.166667, 31, 6},{4.428571, 31, 7},{3.875000, 31, 8},{3.444444, 31, 9},
	{3.100000, 31, 10},{2.818182, 31, 11},{2.583333, 31, 12},{2.384615, 31, 13},
	{2.214286, 31, 14},{2.066667, 31, 15},{1.937500, 31, 16},{1.823529, 31, 17},
	{1.722222, 31, 18},{1.631579, 31, 19},{1.550000, 31, 20},{1.476190, 31, 21},
	{1.409091, 31, 22},{1.347826, 31, 23},{1.291667, 31, 24},{1.240000, 31, 25},
	{1.192308, 31, 26},{1.148148, 31, 27},{1.107143, 31, 28},{1.068966, 31, 29},
	{1.033333, 31, 30},{0.968750, 31, 32},{32.000000, 32, 1},{10.666667, 32, 3},
	{6.400000, 32, 5},{4.571429, 32, 7},{3.555556, 32, 9},{2.909091, 32, 11},
	{2.461539, 32, 13},{2.133333, 32, 15},{1.882353, 32, 17},{1.684211, 32, 19},
	{1.523810, 32, 21},{1.391304, 32, 23},{1.280000, 32, 25},{1.185185, 32, 27},
	{1.103448, 32, 29},{1.032258, 32, 31},
};
...
int resize_lut_calc (int srcN, int dstM, int upScale, unsigned int coef[], float fixed_point_coef)
{
	...
	if (upScale)
	{
		for (i = 0, t = 0; i < dstM; i++)
		{
			...
			w_coef = 1.0 - factor2;
			coef[i] = ((unsigned int)(fixed_point_coef * w_coef)) << 2;
	...
	else
	{
		for (i = 0, t = 0, x = 0; i < srcN; i++)
		{
			...
			if (dstM == 1)
			{
				coef[i] = (i == 0) ? ((((int)fixed_point_coef / 2) << 2) | 0x3) : 0x2;
				continue;
			}
...
int jz47_calc_resize_para ()
{
	...
	if (width_resize_enable)
	{
		...
		resize_lut_calc (srcN, dstM, width_up, jz47_ipu_module.resize_para.width_lut_coef, fixpoint_lut_coef);
	...
	if (height_resize_enable)
	{
		...
		resize_lut_calc (srcN, dstM, height_up, jz47_ipu_module.resize_para.height_lut_coef, fixpoint_lut_coef);
