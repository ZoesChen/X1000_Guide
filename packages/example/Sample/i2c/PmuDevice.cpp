...
public:
	...
	int PmuSmbWriteByte(unsigned char reg, unsigned char slave_addr);
};
...
int PmuDevice:: PmuSmbWriteByte(unsigned char reg, unsigned char slave_addr)
{
...
int main()
{
	...
	Pmu.PmuSmbWriteByte(0x07, slave_addr);
	Pmu.PmuSmbReadByte(0x07, slave_addr);
}
