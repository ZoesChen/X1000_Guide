...
ifeq ($(use_ula), 1)
LOCAL_MODULE=aiengine-4mic
else
LOCAL_MODULE=aiengine-1mic
endif
...
LOCAL_LDLIBS := -lc -lpthread -lm -lasound
...
LOCAL_DEPANNER_MODULES := aiengine-lib create_data alsa-include
