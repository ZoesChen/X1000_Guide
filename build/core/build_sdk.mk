...
DOC_FILES := $(TOPDIR)/docs/html \
			 $(TOPDIR)/docs/latex

ifneq ($(filter win_sdk,$(MAKECMDGOALS)),)
WIN_CROSS_TOOLCHAINS := $(TOPDIR)/prebuilts/toolchains/mips-gcc472-glibc216-mingw32
WIN_HOST_TOOLS := $(TOPDIR)/prebuilts/win-tools
WIN_SDK_BUILD := $(TOPDIR)/build/core/sdk-build.cmd
...
ifneq ($(filter win_sdk,$(MAKECMDGOALS)),)
	$(call copy-sdk-files,$(WIN_CROSS_TOOLCHAINS),$(PRIVATE_DIR)/prebuilts/toolchains/mips-gcc472-glibc216)
	$(call copy-sdk-files,$(WIN_HOST_TOOLS)/make.exe,$(PRIVATE_DIR)/make.exe)
	$(call copy-sdk-files,$(TOPDIR)/build/core/sdk-build.cmd,$(PRIVATE_DIR)/sdk-build.cmd)
else
	$(call copy-sdk-files,$(TOPDIR)/build/core/sdk-build,$(PRIVATE_DIR)/sdk-build)
	$(call copy-sdk-files,$(COMPILER_PATH),$(PRIVATE_DIR)/prebuilts/toolchains/mips-gcc472-glibc216)
	$(call copy-sdk-files,$(TOPDIR)/prebuilts/eclipse_install/,$(PRIVATE_DIR)/prebuilts/eclipse_install)
endif
ifneq ($(strip x$(ALL_BUILD_SAMPLE_PATH)),x)
	...
	$(call mv-sdk-files,$(DOC_FILES),$(PRIVATE_DIR)/docs/)
